...
write.csv(df_scotch,'scotch_CD4vsAll_sample8.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_CD8vsAll_sample8.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_BvsAll_sample8.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_NKvsAll_sample8.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_MonocytesvsAll_sample8.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_CD4vsAll_sample7.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_CD8vsAll_sample7.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_BvsAll_sample7.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_NKvsAll_sample7.csv')
...
df_scotch = df_gene%>%left_join(df_transcript,by=c('genes'='gene'))
write.csv(df_scotch,'scotch_MonocytesvsAll_sample7.csv')


####################################################################
##################-----sample7 vs sample8----------#################
####################################################################
setwd("/Users/zhuoranx/Documents/ResearchProject/SingleCellLongReads/data/PBMC/results/scotch")
###B 
